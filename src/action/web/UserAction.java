                ...
                if (user!=null){
                    ...
                    if (decryptResult!=null){
                        ...
                        if (mobile.equals(user.getMobile()) && decryptPass.equals(password)) {
                            ...
                            if (mobile.equals(user.getMobile())&&!password.equals(decryptPass)){
                                jsonData.put("code", "1");
                                jsonData.put("msg", "天呢！密码错误");
                                System.out.println("===============密码错误：mobile：" + mobile + "   password：" + password + "===============");
                                return  ERROR;

                            }else if (!mobile.equals(user.getMobile())&&password.equals(decryptPass)){
                                jsonData.put("code", "1");
