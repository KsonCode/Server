...
<script src="./js/hm.js"></script><script type="text/javascript" src="./js/jquery-2.0.3.min.js"></script>
</head>
...
<div class="wid">
  ...
  <div id="rcontentbox">
    ...
    <div id="iapilist" class="clearfix">
          ...
          <li>
            <div class="iapileft"><a href="https://www.zhaoapi.cn/api/recipe/" target="_blank"><img src="./js/recipe.png" height="32">菜谱大全</a></div>
